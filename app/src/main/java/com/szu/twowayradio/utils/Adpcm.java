...
public class Adpcm {
    ...
    public static void adpcmCoder (short[] indata, byte[] outdata, int len, AdpcmState state)
    {
        ...
        for ( ; len > 0 ; len-- ) {
            ...
            */
            ...
            if ( bufferstep ) {
            	...
            	//System.out.print(delta + "," + outputbuffer + ",");
            	//System.out.println((delta<< 4 & 0xf0));

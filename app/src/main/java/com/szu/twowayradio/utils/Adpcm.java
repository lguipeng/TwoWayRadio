...
import com.szu.twowayradio.domain.AdpcmState;
...
public class Adpcm {
	  ...
	  public static char adpcmCoder (short[] indata, byte[] outdata, int len,
				AdpcmState state)
			{
...
//				    System.out.printf("%x ",outp[j]);
	  ...
	  public static  void adpcmDecoder (byte[] indata, short[] outdata, int len,
			  AdpcmState state)
			{
